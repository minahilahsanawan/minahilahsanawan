...
I am currently strengthening my foundation through hands-on work in **C++**, **Python**, **MATLAB-based simulation**, **machine learning workflows**, **embedded systems**, **electronics**, and **frontend development**.
...
* Python programming for automation and engineering workflows
* Data handling, file processing, and structured programming
* Modular software architecture and problem-solving
...
* Computer vision concepts and implementation basics
...
* MATLAB-based modelling and simulation
* Control systems and feedback concepts
* Arduino-based prototyping and sensor integration
* Bluetooth-enabled embedded control systems
* Circuit simulation using LTspice and Proteus
...
Building structured software solutions using C++, Python, and modern frontend technologies for practical engineering and digital applications.
...
Exploring computer vision, natural language processing, classification pipelines, and applied machine learning workflows.
...
Developing embedded and hardware-integrated solutions using Arduino, sensors, Bluetooth communication, and real-time device interaction.
...
Strengthening control-oriented modelling, MATLAB and Simulink workflows, and circuit-level simulation using LTspice and Proteus.
